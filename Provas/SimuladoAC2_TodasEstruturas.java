//Uma loja está informatizando seu sistema de controle de estoque e precisa de um programa em Java capaz de registrar produtos, 
//classificar o nível do estoque, calcular reposições necessárias e gerar estatísticas completas da situação do armazém.
//O sistema deve permitir ao usuário executar vários ciclos de controle, podendo alterar ou manter o limite mínimo de estoque entre as execuções.

package com.mycompany.simulado_ac2;

import java.util.Scanner;

public class Simulado_AC2 {
